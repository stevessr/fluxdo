...
import 'webview_cookie_manager_page.dart';
...
class _WebViewPageState extends ConsumerState<WebViewPage> {
  ...
  Future<void> _showCookieManager() async {
    ...
    try {
      await WebViewCookieManagerPage.open(context, _currentUrl);
      if (!mounted) return;
