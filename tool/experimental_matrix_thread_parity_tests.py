...
path = Path('test/pages/chat/matrix_thread_page_test.dart')
path.write_text(r'''import 'package:fluxdo/pages/chat/matrix_thread_page.dart';
...
''')
print('Matrix thread parity tests staged successfully')
